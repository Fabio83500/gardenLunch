          ...
          <div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div className="sm:flex sm:items-center sm:justify-between">
              <a href="#accueil" className="flex justify-center items-center mb-4 sm:mb-0 space-x-3 ">
                <Image src={gardenLunch} className='w-40' alt="Logo" />
              </a>
              <ul className="font-medium sm:mb-0 dark:text-gray-400">
                <li>
            ...
            <span className="block text-sm ">© 2025
              <a href="#accueil" className="hover:underline"> GardenLunch </a>.Tous droits réservés .</span>
          </div>
        </footer>
        </>
    )
